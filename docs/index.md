...
- **Enjoy with Community Triggers**. You can use many [triggers provided by the community](/docs/triggers.md#triggers-list) (Like Slack, RSS, Typeform, Email, Reddit, NPM, Telegram, Twitter...), you can also [create your own triggers](/docs/creating-triggers.md) easily.
