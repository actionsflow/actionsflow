...
- **Enjoy with Community Triggers**. You can use many [triggers provided by the community](https://actionsflow.github.io/docs/triggers/#triggers-list) (Like Slack, RSS, Typeform, Email, Reddit, NPM, Telegram, Twitter...), you can also [create your own triggers](https://actionsflow.github.io/docs/creating-triggers/) easily.
